...
\only<2>{\begin{textblock}{6.7}(5.85,4.6)
\begin{alertblock}{}\fontsize{11}{12}\sf
$y_t = \sqrt{(\text{lynx in year $t$})}$
\centerline{$y_t = 56.3 + 1.5y_{t-1} - 0.9y_{t-2} - 0.3 \varepsilon_{t-1} + \varepsilon_t$}
\mbox{}\hfill$\varepsilon_t \sim \text{NID}(0,508)$
\end{alertblock}
\end{textblock}}
\vspace*{3cm}
