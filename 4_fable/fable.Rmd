...
\pause
  ...
  * Relative errors  $\varepsilon_t=\frac{y_t-\pred{y}{t}{t-1}}{\pred{y}{t}{t-1}}\sim \text{NID}(0,\sigma^2)$
...
## Example: National Exports

\fontsize{9}{9}\sf

```{r ses-fit, echo=TRUE, cache=TRUE}
fit <- global_economy %>%
  model(ets = ETS(Exports))
fit
```
