...
- Create time plots of the following time series: Bricks from `aus_production`, Lynx from `pelt`, Google from `gafa_stock`
...
Use `gg_lag` and `ACF` on the Snowy Mountains tourism data. What do you learn about the series?
